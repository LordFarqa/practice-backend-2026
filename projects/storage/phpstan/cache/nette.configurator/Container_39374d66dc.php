...
class Container_39374d66dc extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('081'),
			[
				'#Access to an undefined property App\\\Dto\\\Hotel\\\HotelResponseDto::\$hotel_data#',
				'#Class App\\\Http\\\Middleware\\\AdminRoleMiddleware not found#',
			],
			true
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_39374d66dc $container)
			{
	...
	public function createServiceContainer(): Container_39374d66dc
	{
		return $this;
	}
