...
class Container_6bc1786746 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			$this->getService('081'),
			['#Unsafe usage of new static#', '#Access to an undefined property#', '#Relation .* is not found#'],
			true
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_6bc1786746 $container)
			{
		...
		return new PHPStan\File\FileExcluderFactory(
			...
			[
				'analyseAndScan' => [
					...
					'D:\backend_practice\practice-backend-2026\projects\app\Http\Middleware\AdminRoleMiddleware.php',
				],
				'analyse' => [],
			]
		);
	...
	public function createServiceContainer(): Container_6bc1786746
	{
		return $this;
	}
