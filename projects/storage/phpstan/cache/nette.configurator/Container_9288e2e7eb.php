...
// source: phar://D:\backend_practice\practice-backend-2026\projects\vendor\phpstan\phpstan\phpstan.phar/conf/config.level5.neon
...
class Container_9288e2e7eb extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService051(): PHPStan\Analyser\Ignore\IgnoredErrorHelper
	{
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				...
				'#Access to an undefined property App\\\Models\\\Reviews::\$message#',
				'#Parameter \#1 \$callback of method Illuminate\\\Support\\\Collection::filter\(\)#',
			],
			true
		);
	}
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_9288e2e7eb $container)
			{
	...
	public function createServiceContainer(): Container_9288e2e7eb
	{
		return $this;
	}
