...
class Container_be04dc08d6 extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_be04dc08d6 $container)
			{
		...
		return new PHPStan\File\FileExcluderFactory(
			...
			[
				'analyseAndScan' => [
					...
					'D:\backend_practice\practice-backend-2026\projects\app\Http\Middleware',
	...
	public function createServiceContainer(): Container_be04dc08d6
	{
		return $this;
	}
