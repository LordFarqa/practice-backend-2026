...
class Container_feba5adf8c extends _PHPStan_8c66d8255\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_feba5adf8c $container)
			{
	...
	public function createServiceContainer(): Container_feba5adf8c
	{
		return $this;
	}
